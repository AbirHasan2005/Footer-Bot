    ...
    try:
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("Support Group", url="https://t.me/alhajji_support), InlineKeyboardButton("Bots Channel", url="https://t.me/Discovery_Updates")],
                    [InlineKeyboardButton("source", url="https://t.me/yy8hh")]
                ]
            ),
            quote=True
        )
